...
const startIdx = html.indexOf('function renderTransactions(container) {');
const endIdxStr = '    // =============================================\n    // VIEW 3: WALLETS';
const endIdx = html.indexOf(endIdxStr);
...
`;
    html = html.substring(0, startIdx) + newRenderTx + html.substring(endIdx);
